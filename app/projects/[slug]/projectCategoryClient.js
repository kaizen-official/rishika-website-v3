...
function ProjectCategoryClient({ category, projects }) {
      ...
      <BgLayout>
        <div className='min-h-screen flex items-center justify-center'>
          <div className='text-center'>
            ...
            <Link href='/projects' className='text-[#E85002] hover:text-[#A07558]'>
              Back to Projects
            </Link>
          </div>
        </div>
    ...
    <BgLayout>
      ...
      <section className='relative h-[50vh] mt-27 lg:mt-20 flex items-center justify-center overflow-hidden'>
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white'>
          ...
          >
            ...
            <Link href='/projects' className='hover:text-[#D9C3AB] transition-colors'>
              Projects
            </Link>
            <IconChevronRight size={16} className='text-[#D9C3AB]' />
            <span className='text-[#D9C3AB]'>{category.title}</span>
          </motion.div>
          ...
          >
            {/* <div className='flex justify-center mb-6 text-[#A07558]'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            <h2 className='text-3xl md:text-4xl font-bold text-gray-900 mb-4'>
              Key <span className='text-[#E85002]'>Features</span>
            </h2>
          </motion.div>
            ...
            {category.features.map((feature, index) => (
              ...
              >
                <div className='flex items-start gap-3'>
                  <div className='flex-shrink-0 w-6 h-6 bg-[#E85002] rounded-full flex items-center justify-center mt-1'>
      ...
      <section className='py-10'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            <h2 className='text-3xl md:text-4xl font-bold text-gray-900 mb-4'>
              Available <span className='text-[#E85002]'>Projects</span>
            </h2>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {projects.map((product, index) => (
              ...
              >
                <div className='flex flex-col h-full bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-[#A07558]'>
                  {/* Image Slider */}
                  <div className='relative h-full w-full overflow-hidden'>
                    ...
                    <div className='absolute bottom-4 left-4 text-white'>
                      <p className='text-sm font-semibold bg-[#E85002] px-3 py-1 rounded-full inline-block'>
                        {product.type}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='p-6 flex flex-col flex-grow'>
                    {/* Title */}
                    <h3 className='text-2xl font-bold text-gray-900 mb-2 group-hover:text-[#E85002] transition-colors'>
                      {product.model}
                    </h3>

                    {/* Tagline */}
                    <p className='text-sm text-[#A07558] font-semibold mb-3'>{product.tagline}</p>
                    ...
                    {/* CTA */}
                    <button className='flex flex-row justify-center items-center gap-2 bg-[#E85002] rounded-lg text-white py-3 px-4 w-full text-center font-semibold hover:bg-[#333333] transition-all'>
            ...
            >
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 p-8'>
                    ...
                    <div className='flex gap-2 overflow-x-auto'>
                      {selectedProduct.images.map((image, idx) => (
                        <button
                          key={idx}
                          onClick={() => setCurrentImageIndex(idx)}
                          className={`flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 transition-all ${idx === currentImageIndex ? 'border-[#E85002]' : 'border-gray-200'
                            }`}
                        >
                ...
                <div className='space-y-6'>
                  <div>
                    <span className='inline-block bg-[#E85002] text-white text-sm font-semibold px-3 py-1 rounded-lg mb-2'>
                      {selectedProduct.type}
                    </span>
                    <h2 className='text-3xl font-bold text-gray-900 mb-2'>{selectedProduct.model}</h2>
                    <p className='text-lg text-[#A07558] font-semibold'>{selectedProduct.tagline}</p>
                  </div>
                    ...
                    <div className='space-y-2 '>
                      {selectedProduct.advantages.map((advantage, idx) => (
                        <div key={idx} className='flex items-start gap-2'>
                          <IconCheck size={20} className='text-[#E85002] flex-shrink-0 mt-0.5' />
                  ...
                  <button
                    ...
                    className='w-full bg-[#E85002] hover:bg-[#333333] text-white font-bold py-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl'
                  >
                    Request a Quote
                  </button>
                </div>
              ...
              <form onSubmit={handleFormSubmit} className='space-y-4'>
                <div>
                  ...
                  <input
                    ...
                    required
                    className='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#E85002] focus:border-transparent outline-none'
                ...
                <button
                  ...
                  className='w-full bg-[#E85002] hover:bg-[#333333] text-white font-bold py-4 rounded-lg transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed'
                >
                  {isSubmitting ? (
...
export default ProjectCategoryClient;
