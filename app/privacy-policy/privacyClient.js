      ...
      <section className='relative h-[50vh] mt-27 lg:mt-20 flex items-center justify-center overflow-hidden'>
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white'>
          ...
          >
            ...
            <span className='text-[#D9C3AB]'>Privacy Policy</span>
          </motion.div>
          ...
          >
            <h1 className='text-5xl md:text-6xl lg:text-7xl font-bold mb-6'>
              Privacy <span className='text-[#A07558]'>Policy</span>
            </h1>
          </motion.div>
        </div>
      </section>
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <div className="p-6 bg-white rounded-2xl shadow">
              ...
              <ul className="list-disc list-inside">
                <li>
                  <span className="font-semibold">Company:</span> Rishika Builders
                </li>
                <li>
                  <span className="font-semibold">Email:</span> info@rishikabuilders.com
                </li>
                <li>
                  <span className="font-semibold">Phone:</span> +91 77400 00635
                </li>
                <li>
                  <span className="font-semibold">Address:</span> 109-110, Ist Floor, MG Mall, Sec-14, Sonipat, Haryana
                </li>
              </ul>
            </div>
          </motion.div>
