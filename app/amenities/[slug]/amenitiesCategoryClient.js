...
function AccessoryCategoryClient({ category, amenities }) {
        ...
        try {
            const response = await fetch('/api/submit-form', {
                ...
                body: JSON.stringify({
                    ...
                    message: `Enquiry for ${formData.model}`
                })
            });
            ...
            <section className='relative h-[50vh] mt-27 lg:mt-20 flex items-center justify-center overflow-hidden'>
                ...
                <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white'>
                    ...
                    >
                        ...
                        <Link href='/amenities' className='hover:text-[#D9C3AB] transition-colors'>
                            Amenities
                        </Link>
                        <IconChevronRight size={16} className='text-[#D9C3AB]' />
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    >
                        <h2 className='text-3xl md:text-4xl font-bold text-gray-900 mb-4'>
                            Amenity <span className='text-[#E85002]'>Details</span>
                        </h2>
                        <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                            Discover the features of our {category.title} amenities.
                        </p>
                    </motion.div>

                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                        {amenities.map((accessory, index) => (
                            <motion.div
                                key={accessory.slug}
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                                <div className='flex flex-col h-full bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-[#A07558]'>
                                    ...
                                    <div className='p-6 flex flex-col flex-grow'>
                                        ...
                                        {/* Tagline */}
                                        <p className='text-sm text-[#A07558] font-semibold mb-3'>{accessory.tagline}</p>
                                        ...
                                        {/* View Details Button */}
                                        <button className='mt-auto w-full bg-[#E85002] text-white py-3 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2'>
                                            View Details
                            ...
                            <div className='grid lg:grid-cols-2 gap-8 p-8'>
                                        ...
                                        <div className='grid grid-cols-4 gap-2'>
                                            {selectedAccessory.images.map((img, idx) => (
                                                <button
                                                    key={idx}
                                                    onClick={() => setCurrentImageIndex(idx)}
                                                    className={`aspect-square rounded-lg overflow-hidden border-2 transition-all ${idx === currentImageIndex ? 'border-[#E85002]' : 'border-gray-200'
                                                        }`}
                                                >
                                ...
                                <div className='space-y-6'>
                                    <div>
                                        ...
                                        <p className='text-lg text-[#E85002] font-semibold mb-2'>{selectedAccessory.tagline}</p>
                                        ...
                                        <ul className='space-y-2'>
                                            {selectedAccessory.advantages.map((advantage, idx) => (
                                                <li key={idx} className='flex items-start gap-2'>
                                                    <span className='text-[#A07558] mt-1'>•</span>
                                    ...
                                    <button
                                        ...
                                        className='w-full bg-[#E85002] text-white py-4 rounded-xl font-semibold hover:bg-[#333333] transition-colors flex items-center justify-center gap-2'
                                    >
                                        {/* <IconPhone size={20} /> */}
                                        Enquire Now
                                    </button>
