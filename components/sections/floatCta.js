      ...
      <section className='fixed bottom-0 sm:hidden left-0 right-0 flex justify-center z-35'>
        <div className='w-full flex shadow-2xl'>
          ...
          <button
            ...
            className='w-1/2 text-lg bg-[#E85002] text-white py-3 font-semibold hover:bg-[#333333] transition-colors flex items-center justify-center'
          >
            Get Free Quote
          </button>
          ...
          <div className='w-1/2 bg-white flex'>
            ...
            >
              <FaPhone className="text-3xl text-[#E85002] rotate-90" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className='fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4'>
          <div className='bg-white rounded-lg shadow-2xl w-full max-w-md relative animate-fadeIn'>
            ...
            <div className='p-6'>
              ...
              <p className='text-gray-600 mb-6'>Fill in your details and our real estate experts will get back to you shortly.</p>
              ...
              >
                ...
                <input type="hidden" name="_subject" value="New Free Consultation Request - Rishika Builders" />
